...
public class UserController {
	...
	public int idCheck(@RequestParam("user_id") String id, HttpServletResponse response) {
		UserDTO to = new UserDTO();
		to.setId(id);
	...
	public UserDTO userProfile(HttpServletRequest request) throws Exception {
		UserDTO to = new UserDTO();
		to.setNick(request.getParameter("nick"));
		to = userService.userProfile(to);
		return to;
