		...
		// 검색 글자수 validation
			if(strSearchName.length<2){
				...
				if (keyword != null){
					...
					// 고캥핑 API로부터 캠핑장 리스트를 XML로 받아오는 함수
						...
						if(request.readyState==4){
							if(request.status==200){
								...
								for(i=0;i<facltNm.length;i++){
									...
									html+="</td>";		
									html+="<td class='product-category'><span class='categories' style='text-align:center'>"+nvl(induty[i])+"</span></td>";		
